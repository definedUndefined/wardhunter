  ...
  return (
    <section>
      <div className="h-screen flex items-center justify-center bg-[#03000e]">
        ...
        <div className="relative flex flex-col rounded-xl bg-clip-border text-white shadow-lg border border-white p-8 bg-black/50">
          ...
          >
            ...
            <Button
              className="bg-black hover:bg-teal-500"
              type="submit"
            ...
            <Link
              href="/"
              className="ml-2 text-sm text-slate-300 hover:underline"
            >
              Retour à l'accueil
            </Link>
          </form>
